...
class widget_latestcategory extends WP_Widget {
       ...
       function widget($args, $instance) {
               ...
               //'tag__not_in' => array(get_tag_ID('anamanset'),get_tag_ID('surmanset'),get_tag_ID('sonhaber'));
               //print_r(array(get_tag_ID('anamanset'),get_tag_ID('surmanset'),get_tag_ID('sonhaber')));
