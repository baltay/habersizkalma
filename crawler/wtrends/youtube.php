<?php
	...
	*/
	class YoutubeService
	{
		...
		function __construct($email,$password,$key,$source)
		{
			$this->email = $email;
		...
		function GetToken($title,$description)
		{
		    $postdata = "Email=".$this->email."&Passwd=".$this->password."&service=youtube&source=" . $this->source;
		    ...
		    $youtube_video_title = $title; // This is the uploading video title.
		    $youtube_video_description = $description; // This is the uploading video description.   
